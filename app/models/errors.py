...
class ProjectHasExist(Exception):
    pass


class CoverageNotExist(Exception):
    pass


class UsageNotExist(Exception):
    pass


class PatternNotExist(Exception):
    pass
...
class EnreRunError(Exception):
    pass


class DirAnalyzeError(Exception):
    pass
...
class GitRepoNotExist(Exception):
    pass
...
class GitFetchingError(Exception):
    pass